...
## [src/estimation_loop.py](src/estimation_loop.py) (main script)
...
## [src/mpc/mpc_optimizer.py](src/mpc/mpc_optimizer.py) (Bioreactor and Controller class definitions)
...
## [src/models/ssm.py](src/models/ssm.py) (state-space model)

- `lsim_mod()`: a modified version of `scipy.signal.lsim`

## [src/data/functions.py](src/data/functions.py) (utilities)

- Minor updates

## [data/dmc-test-with-mr24-030-experiment-data/dmc_test.yaml](data/dmc-test-with-mr24-030-experiment-data/dmc_test.yaml) (configuration file)
